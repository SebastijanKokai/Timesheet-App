...
namespace Timesheet_API.Models.Migrations
{
    ...
    [Migration("20220316093822_InsertedDeletedDateInUser")]
    partial class InsertedDeletedDateInUser
    {
            ...
            modelBuilder.Entity("Timesheet_API.Models.Models.LeadProject", b =>
                {
                    ...
                    b.HasKey("UserTableId", "ProjectId");
            ...
            modelBuilder.Entity("Timesheet_API.Models.Models.LeadProject", b =>
                {
                    b.HasOne("Timesheet_API.Models.Models.UserProject", "UserProject")
                        .WithOne("LeadProject")
                        .HasForeignKey("Timesheet_API.Models.Models.LeadProject", "UserTableId", "ProjectId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Timesheet_API.Models.Models.ProjectTask", b =>
                {
                    ...
                    b.HasOne("Timesheet_API.Models.Models.UserProject", "UserProject")
                        .WithMany("TaskTables")
                        .HasForeignKey("UserTableId", "ProjectId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Timesheet_API.Models.Models.UserProject", b =>
                {
                    ...
                    b.HasOne("Timesheet_API.Models.Models.User", "UserTable")
                        .WithMany("UserProjects")
